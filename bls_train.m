function [TrainingAccuracy,TestingAccuracy,Training_time,Testing_time, beta11, ps , wh, l2, beta] = bls_train(train_x,train_y, test_x,test_y,s,C,N1,N2,N3)
...
if N1*N2>=N3
     wh=orth(2*rand(N2*N1+1,N3)-1);%% check later why
else
...
% % Get binary predictions and true labels
% predictions = y;
% true_labels = test_yy;
% 
